...
from RISHUMUSIC.utils.inline import panel_markup_clone
...
from RISHUMUSIC.utils.decorators.play import CPlayWrapper
...
@Client.on_callback_query(filters.regex("RISHUmousAdmin") & ~BANNED_USERS)
async def RISHUmous_check(client: Client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@Client.on_callback_query(filters.regex("RISHUPlaylists") & ~BANNED_USERS)
@languageCB
...
import config
from RISHUMUSIC import Carbon, YouTube
from RISHUMUSIC.core.call import RISHU
